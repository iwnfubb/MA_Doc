...
Anhand der Tabelle \ref{fig:compare_bgsubtraction} wird klar, dass das KNN-Verfahren bei allen Testvideos zuverlässige Resultate und bei gleicher Zeit liefert. Die Abbildung \ref{fig:vibeknn} stellt die Laufzeit von KNN und Vibe auf einem Rechner mit einem Intel i5 3,20 GHz Prozessor dar.
