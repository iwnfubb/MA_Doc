...
Anhand der Abbildung \ref{fig:compare_bgsubtraction} wird klar, dass das KNN-Verfahren bei allen Testvideos zuverlässige Resultate und bei gleicher Zeit liefert.
%neue Grafik
\begin{figure}[H]
	\centering
