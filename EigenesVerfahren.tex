...
Eine Begrenzungsbox wird an dieser Stelle erstellt, um das sich bewegende Objekt zu begrenzen. Diese Begrenzungsbox wird für die Erkennung der Körperhaltung im nächsten Abschnitt genutzt.\\
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.7\textwidth]{fig/fuzzylogik.pdf}
