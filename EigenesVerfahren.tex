...
\begin{figure}[H]
	\centering	
	\includegraphics[width=1\textwidth]{fig/knn_vs_vibe_edit.pdf}
	\caption{Laufzeitanalyse von ASB und KNN-Plus-ASB}
	\label{fig:knn_vs_vibe}
\end{figure}
...
\begin{figure}[H]
	...
	\caption{Überprüfung der Schätzung der Körperhaltung am Testvideo \glqq{}fallen2.mp4\grqq{}. Die x-Achse stellt die Framenummer dar und die y-Achse zeigt die Indexe der Körperhaltung. Die blaue Gerade ist die Referenz-Körperhaltung und die gelbe Gerade ist die geschätzte Körperhaltung. Die Schätzung der Körperhaltung hat in diesem Beispiel eine Genauigkeit von 76,47\%.} 
	\label{fig:schatzeva}
\end{figure}
