...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{fig/finalROC.pdf}
...
\begin{table}[H]
	...
	\begin{tabular}[H]{|c|cc|cc|c|}
		\hline 
		{\multirow{ 2}{*}{}} & \multicolumn{5}{c|}{abnormale Situation}\\
		\cline{2-6}
		& TPR & FPR & TNR & FNR & ACC\\
		\hline
		
		ASB & 0,697 & 0,222 & 0,777 & 0,302 & 0,754\\
		
		KNN-Plus-ASB 1280x720& 0,815 & 0,088 & 0,911 & 0,184 & 0,883\\
		
		KNN-Plus-ASB 854x450 & 0,796 & 0,117 & 0,882 & 0,203 & 0,856\\
		\hline
	\end{tabular}
	\caption{Auswertung der verschiedenen Methoden mit und ohne Skalierung des Bilds.}
	\label{tbl:auswertung}
\end{table}

In Tabelle \ref{tbl:auswertung} sind die Auswertungen der Testvideos zu sehen, die als Eingabe für die entwickelte Software dienten. Dabei stehen TNR für \glqq{}True Negative Rate\grqq{}, FNR für \glqq{}False Negative Rate\grqq{}, TPR für \glqq{}True Positive Rate\grqq{}, FPR für \glqq{}False Positive Rate\grqq{} und ACC für \glqq{}Accuracy\grqq{}.\\
