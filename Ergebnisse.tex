...
Um eine bessere Übersicht über die Zielgenauigkeit des Programms zu schaffen, wurde eine ROC-Kurve (siehe Abbildung \ref{fig:roc}) des verwendeten Algorithmus aufgestellt.
