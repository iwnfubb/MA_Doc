...
\end{equation}
Unter Verwendung dieser Wahrscheinlichkeitsschätzung wird das Pixel als ein Vordergrundpixel betrachtet, wenn $P(x_t)<T$, wobei der Schwellenwert $T$ ein globaler Schwellenwert über das gesamte Bild ist, der eingestellt werden kann, um einen gewünschten Prozentsatz von Falsch-Positiven zu erreichen.\\
